...
export default function CheckoutPage() {
    ...
    try {
      ...
      for (const item of items) {
        ...
        if ((count || 0) < item.quantity) {
          throw new Error(`สินค้า ${item.name} หมดหรือสต็อกไม่พอ`);
        }
      }
  ...
  return (
    <div className="bg-[#0F0A1E] min-h-screen py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-card rounded-2xl border border-purple-800/30 p-6">
              <h3 className="text-white font-bold mb-4">วิธีการชำระเงิน</h3>
            ...
            <div className="glass-card rounded-2xl border border-purple-800/30 p-6">
              <h3 className="text-white font-bold mb-4">ตรวจสอบรายการสินค้า</h3>
          ...
          <div>
            <div className="glass-card rounded-2xl border border-purple-800/30 p-6 sticky top-24">
              ...
              <div className="border-t border-purple-900/30 pt-3 flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-700 to-purple-500 hover:from-purple-600 hover:to-purple-400 disabled:opacity-50 text-white py-4 rounded-2xl font-black text-lg transition-all flex items-center justify-center gap-2"
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : `ยืนยันชำระเงิน ฿${formatPrice(total)}`}
              </button>
            </div>
          </div>
        </div>
